...
def test_model(model, optimizer, criterion, test_dataloader):
    ...
    plt.savefig('/home/accelerator/MLP/cm.png', dpi=600, bbox_inches="tight")
    plt.close()
...
if __name__ == '__main__':
    ...
    dataset = Fire('/home/accelerator/bands_test')
    ...
    plt.savefig('/home/accelerator/MLP/loss.png', dpi=600, bbox_inches="tight")
    plt.close()
    ...
    plt.ylabel("Accuracy")
    plt.title("Fire Data - Classification")
    plt.savefig('/home/accelerator/MLP/accuracy.png', dpi=600, bbox_inches="tight")
    plt.close()
    
    torch.save(model.state_dict(), '/home/accelerator/MLP/MLP_checkpoint.pt')
